...
public class OnNextSongClickListener implements View.OnClickListener {
    ...
    public OnNextSongClickListener(ImageView playPauseButton,
    ...
    public void onClick(View view) {
        if(CurrentMusic.getInstance().getPosition() == songs.size()-1){
            CurrentMusic.getInstance().setPosition(0);
        }else {
